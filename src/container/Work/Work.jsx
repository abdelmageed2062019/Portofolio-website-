...
const Work = () => {
  ...
  const [animateCard, serAnimateCard] = useState({ y: 0, opacity: 1 });
  ...
  const handelWorkFilter = (item) => {
    ...
    serAnimateCard([{ y: 100, opacity: 0 }]);

    setTimeout(() => {
      serAnimateCard([{ y: 0, opacity: 1 }]);
  ...
  return (
    <>
      ...
      <div className="app__work-filter">
        {["Landing Page", "Next Js", "React Js", "Angular", "All"].map(
          (item, index) => (
            <div
              key={index}
      ...
      >
        {filterWork.map((work, index) => (
          <div
            className={
              theme === "dark"
                ? "app__work-item app__flex dark-bg"
          ...
          >
            ...
            <div className="app__work-content app__flex">
              ...
              <div
                className={
                  theme === "dark"
                    ? "app__work-tag app__flex dark-bg"
